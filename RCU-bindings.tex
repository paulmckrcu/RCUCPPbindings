...
unlikely to apply in the short term.
...
In time, it is quite possible that a need for C++ RCU domains will
appear.
...
but were also intended to address the need for isolation of one users
readers from other users' grace periods.
...
\item	Add explanatoin of the purpose of domains.
\end{itemize}
