...
10   virtual void retire(class rcu_head *rhp,
...
to \co{rcu_read_lock()} and \co{rcu_read_unlock()}, as discussed at
...
The \co{rcu_head_delete} class provides overloaded \co{retire()} methods,
as shown in
